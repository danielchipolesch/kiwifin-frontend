		...
		<div id="home" class="landing-wrapper overflow-hidden">
			<div class="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static mb-3">
				<a class="flex align-items-center" href="#">
					<img :src="logoUrl" alt="KFG Logo" height="50" class="mr-4 lg:mr-20" />
					<!-- <span class="text-900 font-medium text-2xl line-height-1 mr-8 text-green-500">KFG</span> -->
				</a>
			...
			<div
				...
				<div class="mx-4 md:mx-8 mt-0 md:mt-4">
					...
					<Button label="Saiba mais" class="p-button-rounded text-xl border-none mt-5 bg-green-500 font-normal text-white line-height-3 px-3"></Button>
				</div>
			...
			<div id="features" class="py-4 px-4 lg:px-8 mt-5 mx-0 lg:mx-8">
				<div class="grid justify-content-center">
					<div class="col-12 text-center mt-8 mb-4">
						<h2 class="text-900 font-normal mb-2">Nosso Propósito</h2>
						<span class="text-600 text-2xl">Este é o nosso propósito</span>
					</div>
					...
					<div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
						<div
							...
							<div class="p-3 surface-card h-full" style="border-radius: 8px">
								...
								<h5 class="mb-2 text-900">Fácil de usar</h5>
					...
					<div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
						<div
							...
							<div class="p-3 surface-card h-full" style="border-radius: 8px">
								...
								<h5 class="mb-2 text-900">Design moderno</h5>
					...
					<div class="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
						<div
							...
							<div class="p-3 surface-card h-full" style="border-radius: 8px">
								...
								<h5 class="mb-2 text-900">Bem documentado</h5>
					...
					<div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
						<div
							...
							<div class="p-3 surface-card h-full" style="border-radius: 8px">
								...
								<h5 class="mb-2 text-900">Código limpo</h5>
					...
					<div class="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
						<div
							...
							<div class="p-3 surface-card h-full" style="border-radius: 8px">
								...
								<h5 class="mb-2 text-900">Modo Noturno</h5>
					...
					<div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
						<div
							...
							<div class="p-3 surface-card h-full" style="border-radius: 8px">
								...
								<h5 class="mb-2 text-900">Pronto para Usar</h5>
					...
					<div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
						<div
							...
							<div class="p-3 surface-card h-full" style="border-radius: 8px">
								...
								<h5 class="mb-2 text-900">Práticas Modernas</h5>
					...
					<div
						...
						<div class="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
							...
							<p class="text-gray-900 sm:line-height-2 md:line-height-4 text-2xl mt-4" style="max-width: 800px">“Contratei a KFG para organizar minhas finanças e posso dizer com convicção que foi a melhor decisão que tomei em anos!”</p>
			...
			<div id="highlights" class="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
				<div class="text-center">
					<h2 class="text-900 font-normal mb-2">Poder na Palma da Mão</h2>
				...
				<div class="grid mt-8 pb-2 md:pb-8">
					...
					<div class="col-12 lg:col-6 my-auto flex flex-column lg:align-items-end text-center lg:text-right">
						...
						<h2 class="line-height-1 text-900 text-4xl font-normal">Aplicativo Móvel</h2>
				...
				<div class="grid my-8 pt-2 md:pt-8">
					<div class="col-12 lg:col-6 my-auto flex flex-column text-center lg:text-left lg:align-items-start">
						...
						<h2 class="line-height-1 text-900 text-4xl font-normal">Site Poderoso</h2>
			...
			<div id="pricing" class="py-4 px-4 lg:px-8 my-2 md:my-4">
				<div class="text-center">
					<h2 class="text-900 font-normal mb-2">Preços Imbatíveis</h2>
					<span class="text-600 text-2xl">Preços mais competitivos do mercado. Confira nossos planos!</span>
				</div>
				...
				<div class="grid justify-content-between mt-8 md:mt-0">
					<div class="col-12 lg:col-4 p-0 md:p-3">
						<div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
							...
							<div class="my-5 text-center">
								<span class="text-5xl font-bold mr-2 text-900">R$0</span>
					...
					<div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
						<div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
							<h3 class="text-900 text-center my-5">Individual</h3>
							<img src="/demo/images/landing/startup.svg" class="w-10 h-10 mx-auto" alt="startup" />
							<div class="my-5 text-center">
								<span class="text-5xl font-bold mr-2 text-900">R$1</span>
								<span class="text-600">por mês</span>
								<Button label="Avalie" class="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light line-height-2 bg-blue-500 text-white"></Button>
							</div>
							<Divider class="w-full bg-surface-200"></Divider>
							<ul class="my-5 list-none p-0 flex text-900 flex-column">
								<li class="py-2">
					...
					<div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
						<div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
							<h3 class="text-900 text-center my-5">Empresarial</h3>
							<img src="/demo/images/landing/enterprise.svg" class="w-10 h-10 mx-auto" alt="enterprise" />
							<div class="my-5 text-center">
								<span class="text-5xl font-bold mr-2 text-900">R$49</span>
								<span class="text-600">por mês</span>
								<Button label="Cotação" class="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light line-height-2 bg-blue-500 text-white"></Button>
							</div>
							<Divider class="w-full bg-surface-200"></Divider>
							<ul class="my-5 list-none p-0 flex text-900 flex-column">
								<li class="py-2">
			...
			<div id="contact" class="py-4 px-4 mx-0 mt-8 lg:mx-8">
				<div class="grid justify-content-between">
					<div class="col-12 md:col-3" style="margin-top: -1.5rem">
						<a @click="smoothScroll('#home')" class="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3 cursor-pointer">
							<img :src="logoUrl" alt="KFG Logo" height="50" class="mr-4 lg:mr-20" />
							<!-- <img :src="logoImageUrl" alt="footer sections" width="50" height="50" class="mr-2" />
                            <h4 class="font-medium text-3xl text-900">Kiwifin Group</h4> -->
						</a>
						<div style="margin-top: 2rem">
							<span>Avenida Rio Branco, 525, Centro - Rio de Janeiro, RJ</span><br />
							<span>21740-122</span>
						</div>
					</div>
