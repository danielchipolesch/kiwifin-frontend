...
const submeterFormulario = (e) => {
    ...
    if(formulario.value.nome && cpfRaw.value && dataRaw.value && formulario.value.email && formulario.value.celular && formulario.value.cep && formulario.value.endereco && formulario.value.complemento && formulario.value.cidade && formulario.value.uf && inserirSenha.value && repetirSenha.value) {
        if (inserirSenha.value === repetirSenha.value){
            formulario.value.dataNascimento = new Date(dataRaw.value.valueOf() - dataRaw.value.getTimezoneOffset()*60000).toISOString().replace(/\.\d{3}Z$/, '');
    ...
    // console.log(form);
//     	submitted.value = true;
// 	if (formulario.value.nome && formulario.value.status) {  
//         registroService.criarRegistroCliente(formulario.value)
        ...
        <div class="flex flex-column align-items-center justify-content-center">
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                    <form action="" @submit="submeterFormulario($event)">
                        ...
                        <div class="grid p-fluid mt-3">
                            ...
                            <div class="field col-12 md:col-3">
                                <span class="p-float-label">
                                    <InputMask id="cpf" mask="999.999.999-99" v-model="cpfRaw" :disabled="false"></InputMask>
                            ...
                            <div class="field col-12 md:col-6">
                                <span class="p-float-label">
                                    <InputText type="email" id="email" v-model="formulario.email" />
                                    <label for="email">E-mail</label>
                                </span>
                            </div>
                            <div class="field col-12 md:col-3">
                                <span class="p-float-label">
                                    <InputMask id="celular" mask="(99) 99999-9999" v-model="formulario.celular"></InputMask>
                                    <label for="celular">Celular</label>
                                </span>
                            </div>
                            <div class="field col-12 md:col-3">
                                <span class="p-float-label">
                                    <InputMask id="cep" mask="99999-999" v-model="formulario.cep" :disabled="false"></InputMask>
                            ...
                            <div class="field col-12 md:col-1">
                                <span class="p-float-label">
                                    <InputText type="text" id="uf" v-model="formulario.uf" :disabled="false"/>
                        ...
                        <div class="grid p-fluid mt-3">
                            <div class="field col-12 md:col-4">
                                <span class="p-float-label">
                                    <InputText type="password" id="insiraSenha" v-model="inserirSenha" :disabled="false"/>
                                    <label for="insiraSenha">Nova Senha</label>
                                </span>
                            </div>
                            <div class="field col-12 md:col-4">
                                <span class="p-float-label">
                                    <InputText type="password" id="repitaSenha" v-model="repetirSenha" :disabled="false"/>
