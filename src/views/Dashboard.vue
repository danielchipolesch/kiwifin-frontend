		...
		<div class="col-12 lg:col-6 xl:col-3">
			<div class="card mb-0">
				<div class="flex justify-content-between mb-3">
					<div>
						<span class="block text-500 font-medium mb-3">Abertos</span>
		...
		<!-- <div class="col-12 xl:col-6">
            <div class="card">
                ...
                <DataTable :value="products" :rows="5" :paginator="true" responsiveLayout="scroll">
                    <Column field="name" header="Requerente" :sortable="true" style="width: 50%"></Column>
                    <Column field="price" header="Assunto" :sortable="true" style="width: 50%">
